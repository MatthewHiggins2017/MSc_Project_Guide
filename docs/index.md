...
To get the most out of this MSc project you should take it not only as an opportunity to gain hands on research experience, but use it as a stepping stone to hone and enhance the skills you need to transition to your next career step.  

**What to expect?** This is an independent research project, you are in the driving seat with the ability to shape it as you see fit. My role as supervisor is to guide and support you through this process. *(More on this later!).* 
...
| Day | Activity |
|---|---|
| **Mondays** | Brainstorm a game plan for the week ahead. |
| **Fridays** | Ahead of this meeting, it would be great to prepare a couple slides to highlight your progress from the week. We will use these to guide our meeting, gauge progress and solve any problems encountered together. |
...
To help you get the most out of your MSc project, I put together the following framework. The process described is what I try to follow within my own research, however I have tailored it to fit within the MSc timeline, to provide clarity of what is expected when. 

-----------------------------------------

### **Phase 1** *(Starting Right)* 

**1)** **Identify Your Aspirations** Identify your own career aspirations (e.g. what you want to achieve in the next 3 years) and what next steps you are interested in (e.g. PhD, industry position, start-up, etc). 
...
**5)** **Objective Ordering**. Determine the order of each objective. What depends on what? What objectives can be completed independently to accelerate progress, etc. I find it helpful to draw this out as a simple flow chart.  
...
**7)** **Initial Workflow Exploration**. Given the nature of the objective, identify what has already been done and published in high-impact journals to address the problem. 

**8)** **Identify Resources**. As the saying goes, there is no point reinventing the wheel, so assess what existing tools, databases, etc, you can use to achieve the objective. This builds on point (7) as to justify your selected approach (tools, databases, etc) you can point to peer-reviewed research.  

**9)** **Start Small & Simple**. Following steps 7 & 8, you should have a rough idea of what's needed to achieve the given objective and how you are going to do it! The next thing is to put that plan into action, in the smallest and simplest form first. This allows you to fail quickly, debug the process and overcome any issues as quickly as possible. By the end of this step you should have a validated workflow to achieve the objective.  

**10)** **Scale Up**. Once you have validated your workflow it's time to scale up and achieve the objective in full! 

**11)** **Document! Document! Document!**. Throughout the entire Phase 2 process, you should consistently document your work. Keep a clear record of your methods as you progress, such as tool versions, scripts, and analysis pipelines, as this will make it much easier to revisit workflows or write up your progress later. As you go, try to create publication-ready figures whenever possible, as this saves a lot of time downstream, compared to revisiting and rerunning an analysis. 
...
In the final month and a half of your project you will transition into Phase 3, and focus on completing your dissertation. I cannot overstate the importance of this stage. Regardless of the career path you choose, the ability to clearly and effectively communicate the work you have undertaken is absolutely essential.

**13)** **Consolidation**. Now you can begin to pull everything together. By robustly documenting your work completed across Phases 1 & 2, the bulk of material for your introduction, methods and results sections should be ready to be pulled together and polished. Do this first!  

**14)** **Discussion Next**. Once the introduction, methods and results sections are complete, it is time to get started on the discussion. Personally, I find this section the most enjoyable to write as you can reflect on the progress you have made and what you would do in the future given more time & resources.  

**15)** **Feedback**. Submit your dissertation draft for review. Ideally, this should be done ~4 weeks before the deadline to give me enough time to review each section, provide feedback and to give yourself time to make any corrections if necessary. 
